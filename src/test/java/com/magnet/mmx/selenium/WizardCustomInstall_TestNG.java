...
//      wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(".btn.btn-primary")));
        ...
        if(existsElement("reports")==true){
        	// on grey padding: new user Welcome screen > Next 
          ...
          driver.findElement(By.xpath(".//*[@id='step-1']/div[3]/button")).click(); Thread.sleep(3000);
        	   ...
        	   System.out.println("New user screen is not present --> going to Dashborad");
        	}
	    ...
	    for (int second = 0;; second++) {
	    	...
	    	try { if (isElementPresent(By.linkText("Profile"))) break; } catch (Exception e) {}
	    	Thread.sleep(1000);}
